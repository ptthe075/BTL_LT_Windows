                        ...
                        <div class="input-boxes">
                            ...
                            <div class="input-box">
                             ...
                             <c:if test="${not empty param.login_error}">
								<div class="input-box alert-danger" role="alert">
                            ...
                            <div class="text sign-up-text">Bạn chưa có tài khoản? <label for="flip">Đăng ký ngay</label></div>
                        </div>
                    </form>
                </div>
                <div class="signup-form">
                    ...
                    <form action="${base}/signup" method="post">
                        <div class="input-boxes">
                            ...
                            <div class="input-box">
                                <i class="fas fa-lock"></i>
                                <input type="password" id="password_confirm" placeholder="Mật khẩu xác nhận" required>
                            </div>
                            <div class="button input-box">
                                <button type="button" onclick="signup('${base}');">Đăng ký</button>
                            </div>
                            <p class="social-text">
                                <span>Hoặc</span>
                            </p>
