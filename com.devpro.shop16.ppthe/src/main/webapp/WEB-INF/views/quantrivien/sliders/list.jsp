...
<body class="sidebar-mini layout-fixed sidebar-collapse">
	<div class="wrapper">
							...
							<div class="card card-primary card-outline card-outline-tabs">
								<div class="card-header p-0 border-bottom-0">
									<ul class="nav nav-tabs" id="custom-tabs-four-tab"
										...
										<li class="nav-item"><a class="nav-link active"
											data-toggle="pill" href="#tabs-list-sliders" role="tab"
											aria-controls="tabs-list-sliders" aria-selected="true">
												Danh sách slide </a>
										</li>
									</ul>
								</div>
								<div class="card-body">
									<div class="tab-content">
										<div class="tab-pane fade show active" id="tabs-list-sliders"
											role="tabpanel">
											<table name-table="table" id="sliders"
												...
												<tbody>
													<c:forEach var="slider" items="${sliders }" varStatus="loop">
														<tr>
															...
															<td><img
																src="${base }/Upload/Sliders/${slider.image}" alt=""
																width="100%">
															</td>
															<c:choose>
															...
															<td class="text-align-center action-item">
																<a href="${base }/admin/sliders/management/${slider.id}" class="btn bg-gradient-primary btn-sm btn-edit">
																	<i class="fas fa-edit"></i>
																</a>
																<c:choose>
																	<c:when test="${slider.status }">
																		<a class="btn bg-gradient-danger btn-sm btn-delete-restore" item-id="${slider.id}">
		...
		<div id="select-nav" name-item="sliders" style="display: none;"></div>
	</div>
	<!-- ./wrapper -->
