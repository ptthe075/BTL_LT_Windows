								...
								<div class="card-header p-0 border-bottom-0">
									<ul class="nav nav-tabs" id="custom-tabs-four-tab"
										...
										<li class="nav-item"><a class="nav-link active"
											data-toggle="pill" href="#tabs-list-categories" role="tab"
											aria-controls="tabs-list-categories" aria-selected="true">
								...
								<div class="card-body">
									<div class="tab-content">
										<div class="tab-pane fade show active"
											id="tabs-list-categories" role="tabpanel">
											<table name-table="table" id="categories"
														...
														<tr>
															...
															<td>
																<c:if test="${not empty category.image}">
																	<img
																	src="${base }/Upload/Categories/${category.image}"
																	alt="" width="100%">
																</c:if>
															</td>
															<c:choose>
															...
															<td class="text-align-center action-item">
																<a href="${base }/admin/categories/management/${category.id}" class="btn bg-gradient-primary btn-sm btn-edit">
																	<i class="fas fa-edit"></i>
																</a>
																
																<c:choose>
																	<c:when test="${category.status }">
																		<a class="btn bg-gradient-danger btn-sm btn-delete-restore" item-id="${category.id}">
